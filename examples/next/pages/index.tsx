...
import { discoverMovies, DiscoverMovies } from '@internal/tmdb';
import { useEffect } from 'react';
import { injector } from '../biz/injector';
import { services } from '../biz/setup/services';
...
export async function getServerSideProps() {
  const result = await discoverMovies(...injector.retrieve(services.fetchRequester));

  return { props: { movies: result } };
}

export function Index({ movies }: { movies: DiscoverMovies }) {
